classdef StirlingEngine < handle
    ...
    properties
        ...
        U_2 = 300;  % Overall heat transfer coefficient of Stirling engine at water side, W/m^2-K
...
%         gamma = 3.375;  % Compression ratio of Stirling engine, ~\cite{Fraser2008}
        s_se = 16.67;  % Speed of Stirling engine, Hz (10Hz, 5kW)
        wf = 'Helium';  % Working fluid, Helium
        k = 1.66;   % Specific heat ratio of the working gas in Stirling engine, for He
        V_DH = 7.088e-8;    % Dead volume of heater, m^3
        V_DC = 1.38e-8;     % Dead volume of cooler, m^3
        V_DR = 5.055e-8;    % Dead volume of regenerator, m^3
        S_E = 1.2008e-7;    % Swap volume of the expand space, m^3
        S_C = 1.1314e-7;    % Swap volume of the compress space, m^3
        C_E = 3.052e-8;     % Clearance volume of the expand space, m^3
        C_C = 2.868e-8;     % Clearance volume fo the compress space, m^3
        n_g = 0.142;        % Amount of working gas in each Stirling engine, mol
...
%         end
        ...
        function h_h = h_h(obj)
            ...
            rho_h = CoolProp.PropsSI('D', 'T', obj.T_wH, 'P', obj.p, ...
                obj.wf);
            v_h = 1e-3;     % Speed of working gas in the heat exchanger
            L_h = obj.N_h * obj.l_h;
        ...
        function h_l = h_l(obj)
            ...
            rho_l = CoolProp.PropsSI('D', 'T', obj.T_wL, 'P', obj.p, ...
                obj.wf);
            v_l = 1e-3;     % Speed of working gas in the heat exchanger
            L_l = obj.N_l * obj.l_l;
