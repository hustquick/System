...
%% Get results matrix
number = 2;
cs = CascadeSystem1.empty(0, number);
...
cs(k).he.st1_i = cs(k).sea.st1_o;
cs(k).dca.st_i = cs(k).he.st1_o;

cs(k).st1(1) = cs(k).sea.st1_i;
cs(k).st1(2) = cs(k).he.st1_i;
cs(k).st1(3) = cs(k).dca.st_i;

cs(k).tb.st_i = cs(k).he.st2_o;
...
Q_rankine = cs(k).sea.st2_i.q_m.v .* (cs(k).sea.st2_o.h -  cs(k).sea.st2_i.h) ...
    ...
    cs(k).he.st2_o.q_m.v .* (cs(k).he.st2_o.h - cs(k).he.st2_i.h);
...
eta_ss_se = (T_H - T_L) ./ (T_H + (1 - e) .* (T_H - T_L) ...
                ./ (ss(k).se.k -1) ./ log(ss(k).se.gamma));
P_ss_se = ss(k).dca.dc.q_tot .* ss(k).dca.eta .* ss(k).dca.n .* eta_ss_se;

ss(k).st2(7).T.v = cs(k).st2(8).T.v;
ss(k).st2(7).p = cs(k).st2(8).p;
ss(k).st2(7).q_m.v = cs(k).st2(8).q_m.v .* (cs(k).st2(11).h - cs(k).st2(8).h) ...
