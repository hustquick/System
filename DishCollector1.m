...
%         eta;        % Thermal efficiency of the collector
    ...
    methods
        function obj = DishCollector(amb)
            obj = obj@Collector(amb);
            obj.A = 87.7;
            obj.gamma = 0.97;
            obj.rho = 0.91;
            obj.shading = 0.95;
            ...
            obj.st_i = Stream(char(Const.Fluid(1)), 1);
            obj.st_o = Stream(char(Const.Fluid(1)), 1);
        end
...
%                 - 4 * obj.airPipe.delta_a;
        ...
        function calc_q_tot(obj)
            obj.q_tot = obj.amb.I_r .* obj.A;
        end
        function calc_q_use(obj)
            obj.q_use = obj.st_i.qm .* (obj.st_o.h - obj.st_i.h);
        end
        function calc_eta(obj)
            obj.eta = obj.q_use ./ obj.q_tot;
        end
